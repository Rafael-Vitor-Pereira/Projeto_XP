        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="ajaxform" name="ajaxform" action="<?php echo site_url("financeiro/grava_custo"); ?>" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="cod">Tipo custo:</label>
                    <select name="cod" id="cod" class="form-control">
                      <option value=""> ---------------------- </option>
                      <option value="1">Salário de Funconários</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="valor" class="form-control" id="valor" placeholder="Valor Gasto">
                  </div>
                </div>
                <!-- /.card-body -->
