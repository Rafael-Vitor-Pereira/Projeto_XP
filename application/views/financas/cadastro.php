        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="ajaxform" name="ajaxform" action="<?php echo site_url("financeiro/gravar"); ?>" method="POST">
                <input type="text" name="setor" value="Financeiro" readonly style="display: none">
                <div class="card-body">
                  <div class="row">
