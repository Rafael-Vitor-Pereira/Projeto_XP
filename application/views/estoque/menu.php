...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="<?= base_url('estoque'); ?>" class="brand-link" style="text-decoration: none;">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="<?= base_url('estoque/cad_prod'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Produtos</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url('estoque/vender'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Vendas</p>
              </a>
            </li>
