                  ...
                  <tbody>
                    ...
                    if ($msg != 0) {
                      ...
                      foreach ($msg as $linha) {
                        if ($linha['remetente'] == $id) {
                          if ($linha['excluido'] == 'sim') {
                            ...
                            if ($linha['nome_remet'] == 'admin') {
                              $remet = 'EU';
                            } else {
                              $remet = $linha['nome_remet'];
                            }
                    ?>
                            <tr>
                              <td>
                              ...
                              <td class="mailbox-name"><a href="ler_msg/<?= $linha['id'] ?>"><?= $remet ?></a></td>
