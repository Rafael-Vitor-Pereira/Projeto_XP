          		...
          		<!-- left column -->
          			<div class="col-md-12">
            			<div class="card card-primary">
              				...
              				<form id="ajaxform" name="ajaxform" action="<?= base_url("usuario/gravarEdicao"); ?>" method="POST">
                				<div class="card-body">
                  					<div class="row">
                  					...
                  					<div class="row">
                    					<div class="form-group col-2">
                      						...
                      						<input type="text" name="telefone" class="form-control" id="telefone" data-inputmask="'mask': '(99) 9 9999-9999'" data-mask value="<?= $dados->telefone ?>">
                    					</div>
                    					<div class="form-group col-2">
									...
									<div class="row">
										<div class="form-group col-4">
											...
											<input type="text" name="login" id="login" class="form-control" placeholder="Login" value="<?= $dados->login ?>">
										</div>
										<div class="form-group col-4">
                    					...
                    					<div class="form-group col-4">
                    						<label for="acesso">Acesso:</label>
                      						<select name="acesso" id="acesso" class="form-control">
                        						<option value="admin" <?= $dados->acesso == 'admin' ? 'selected' : '' ?> >Administrador</option>
                        						<option value="chefe de RH" <?= $dados->acesso == 'chefe de RH' ? 'selected' : '' ?> >Recursos Humanos</option>
                        						<option value="chefe de Estoque" <?= $dados->acesso == 'chefe de Estoque' ? 'selected' : '' ?> >Estoque</option>
                        						<option value="chefe Financeiro" <?= $dados->acesso == 'chefe Financeiro' ? 'selected' : '' ?> >Financeiro</option>
                      						</select>
                    					</div>
                  					</div>
                				</div><!-- /.card-body -->
