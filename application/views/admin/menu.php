      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?= base_url('admin/cadastro'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Usuário</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url('admin/cad_func'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Funcionários</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url('admin/cad_prod'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Produtos</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url('admin/vender'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Nova venda</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url('admin/cad_custo'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Custo</p>
              </a>
            </li>
