        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="ajaxform" name="ajaxform" action="<?php echo base_url("admin/gravar"); ?>" method="POST">
                <div class="card-body">
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input type="text" name="user" class="form-control" id="user" placeholder="Usuário">
                    </div>
                    <div class="form-group col-6">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <select name="setor" id="setor" class="form-control">
                        ...
                        <option value="chefe de finanças">Financeiro</option>
                      </select>
                    </div>
                  </div>
                </div>
